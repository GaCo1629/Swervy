...
public class DrivetrainSubsystem extends Subsystem {
    private static final double TRACKWIDTH = 17.625;
    private static final double WHEELBASE = 19.5;

    private static final double FRONT_LEFT_ANGLE_OFFSET = -Math.toRadians(42.8);
    private static final double FRONT_RIGHT_ANGLE_OFFSET = -Math.toRadians(178);
    private static final double BACK_LEFT_ANGLE_OFFSET = -Math.toRadians(246);
    private static final double BACK_RIGHT_ANGLE_OFFSET = -Math.toRadians(310);
